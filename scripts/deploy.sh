...
#FLAGS="--verbose 1 --genesis-path /genesis.json --bootnodes $MY_IP:$DISCOVERY_PORT"
...
nohup lighthouse vc \
    ...
    --debug-level debug \
    --suggested-fee-recipient 0x0000000000000000000000000000000000000000 > lighthouse_vc.log 2>&1 &
